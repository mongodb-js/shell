...
var shellAutocomplete = function () {
  ...
  var worker = function (prefix) {
    ...
    if (beginning.length)
      beginning += '.';
    var possibilities = [].concat(universalMethods, Object.keySet(curObj), Object.keySet(curObj.__proto__), builtinMethods[curObj] || [], builtinMethods[curObj.__proto__.constructor] || [], curObj === global ? extraGlobals : [], customComplete(curObj));
    var noDuplicates = {};
